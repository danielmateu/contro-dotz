  ...
  return (
    ...
    >
      ...
      <div className="absolute top-[15%] left-[5%] sm:left-[8%] opacity-30 dark:opacity-40 animate-float-slow">
        <div className="p-3 sm:p-4 rounded-2xl bg-gradient-to-br from-pink-500/20 to-violet-500/10 border border-pink-500/20 shadow-lg transform -rotate-12">
      ...
      <div className="absolute top-[18%] right-[8%] sm:right-[12%] opacity-40 dark:opacity-50 animate-float-delayed">
        <div className="p-2.5 sm:p-3.5 rounded-full bg-gradient-to-br from-amber-400/20 to-yellow-500/10 border border-amber-500/30 shadow-lg transform rotate-12">
      ...
      <div className="absolute top-[42%] right-[4%] sm:right-[7%] opacity-35 dark:opacity-45 animate-float-medium hidden xs:block">
        <div className="p-4 sm:p-5 rounded-3xl bg-gradient-to-br from-violet-500/20 via-pink-500/15 to-indigo-500/10 border border-violet-500/25 shadow-xl transform rotate-6">
      ...
      <div className="absolute top-[48%] left-[3%] sm:left-[6%] opacity-35 dark:opacity-45 animate-float-slow">
        <div className="p-3.5 sm:p-4 rounded-2xl bg-gradient-to-br from-indigo-500/20 to-pink-500/15 border border-indigo-500/25 shadow-lg transform -rotate-6">
          <span className="text-2xl sm:text-4xl">🐷</span>
        </div>
      </div>
      ...
      <div className="absolute bottom-[22%] left-[10%] sm:left-[15%] opacity-30 dark:opacity-40 animate-float-delayed">
        <div className="p-2 sm:p-3 rounded-full bg-gradient-to-br from-amber-400/20 to-amber-600/10 border border-amber-500/20 shadow-md transform -rotate-12">
      ...
      <div className="absolute bottom-[18%] right-[8%] sm:right-[12%] opacity-30 dark:opacity-40 animate-float-slow hidden sm:block">
        <div className="p-3 rounded-2xl bg-gradient-to-br from-emerald-500/20 to-teal-500/10 border border-emerald-500/25 shadow-lg transform rotate-6 flex items-center gap-2 text-xs font-bold text-emerald-600 dark:text-emerald-400">
          <span>📈</span>
          <span>+24% Ahorro</span>
        </div>
      </div>
      ...
      <div className="absolute top-[28%] left-[7%] sm:left-[12%] opacity-35 dark:opacity-45 animate-float-medium hidden md:block">
        <div className="p-3 rounded-2xl bg-gradient-to-br from-indigo-500/20 via-purple-500/15 to-pink-500/10 border border-indigo-500/25 shadow-xl transform -rotate-12 flex items-center gap-2">
